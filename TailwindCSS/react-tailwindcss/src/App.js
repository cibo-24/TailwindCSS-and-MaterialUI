      ...
      <body className='bg-white h-full flex-col  dark:bg-gray-900 dark:text-white sm:bg-pink-300 md:bg-red-300 lg:bg-purple-300 xl:bg-indigo-300 2xl:bg-green-300 '>
        <div className='h-15 bg-gray-100 dark:bg-gray-900 w-full flex justify-between items-center px-5'>
          <a href='https://github.com/cibo-24' className='text-xl font-medium inline-flex items-center text-blue-900 dark:text-white' >
            .cibo24
            <span className='text-sm text-gray-400 ml-2'>v2.4.0</span>
          </a>
        ...
        <div>
          ...
          <main className="h-full flex">
            <aside className='flex flex-shrink-0 absolute lg:relative -translate-x-full lg:-translate-x-0 flex-col  w-64 border-r p-2 border-gray-200 dark:bg-gray-800 divide-solid divide-gray-800 dark:divide-gray-800 divide-y space-y-5 overflow-auto'>
              <nav>
                <a href='#' className="flex items-center h-10 px-3 rounded text-sm text-blue-400 dark:text-white font-medium hover:bg-gray-100 transition-color">Anasayfa</a>
                <a href='#' className="flex items-center h-10 px-3 rounded text-sm text-blue-400 dark:text-white font-medium hover:bg-gray-100 transition-color">Akış</a>
                <a href='#' className="flex items-center h-10 px-3 rounded text-sm text-blue-400 dark:text-white font-medium hover:bg-gray-100 transition-color">Keşfet</a>
                <a href='#' className="flex items-center h-10 px-3 rounded text-sm text-blue-400 dark:text-white font-medium hover:bg-gray-100 transition-color">Makaleler</a>
                <a href='#' className="flex items-center h-10 px-3 rounded text-sm text-blue-400 dark:text-white font-medium hover:bg-gray-100 transition-color">Soru & Cevap</a>
              </nav>

              <nav>
                <a href='#' className="flex items-center h-10 px-3 rounded text-sm text-blue-400 dark:text-white font-medium hover:bg-gray-100 transition-color">HTML</a>
                <a href='#' className="flex items-center h-10 px-3 rounded text-sm text-blue-400 dark:text-white font-medium hover:bg-gray-100 transition-color">CSS</a>
                <a href='#' className="flex items-center h-10 px-3 rounded text-sm text-blue-400 dark:text-white font-medium hover:bg-gray-100 transition-color">JavaScript</a>
                <a href='#' className="flex items-center h-10 px-3 rounded text-sm text-blue-400 dark:text-white font-medium hover:bg-gray-100 transition-color">React</a>
                <a href='#' className="flex items-center h-10 px-3 rounded text-sm text-blue-400 dark:text-white font-medium hover:bg-gray-100 transition-color">Python</a>
              </nav>
            ...
            <section className='flex-auto py-6 px-5 md:px-10 overflow-auto'>
              <div className='mx-auto max-w-screen-xl'>
                <h2 className='text-3xl font-bold mb-4 leading-relaxed text-blue-700 dark:text-white'>History, Purpose and Usage</h2>
                ...
                <div className='bg-twitter rounded-2xl text-white p-7 border dark:border-gray-800 hover:bg-blue-400 dark:bg-gray-800'>
